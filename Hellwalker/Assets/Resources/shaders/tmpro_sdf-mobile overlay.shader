			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat8.x = u_xlat4.x * 1.5;
					    u_xlat12 = (-_PerspectiveFilter) + 1.0;
					    u_xlat12 = u_xlat12 * abs(u_xlat8.x);
					    u_xlat4.x = u_xlat4.x * 1.5 + (-u_xlat12);
					    u_xlat0.x = abs(u_xlat0.x) * u_xlat4.x + u_xlat12;
					    u_xlatb4 = glstate_matrix_projection[3].w==0.0;
					    u_xlat0.x = (u_xlatb4) ? u_xlat0.x : u_xlat8.x;
					    u_xlat4.xy = vec2(_FaceDilate, _OutlineSoftness) * vec2(vec2(_ScaleRatioA, _ScaleRatioA));
					    u_xlat8.x = u_xlat4.y * u_xlat0.x + 1.0;
					    u_xlat1.x = u_xlat0.x / u_xlat8.x;
					    ...
					    u_xlat5.xy = (-vec2(_UnderlayOffsetX, _UnderlayOffsetY)) * vec2(vec2(_ScaleRatioC, _ScaleRatioC));
					    u_xlat5.xy = u_xlat5.xy * vec2(_GradientScale);
					    ...
					    vs_TEXCOORD1.y = (-u_xlat8.x) * u_xlat1.x + u_xlat1.w;
					    vs_TEXCOORD1.z = u_xlat8.x * u_xlat1.x + u_xlat1.w;
					    vs_TEXCOORD1.xw = u_xlat1.xw;
					    u_xlat8.x = in_COLOR0.w * _UnderlayColor.w;
					    vs_TEXCOORD4.xyz = u_xlat8.xxx * _UnderlayColor.xyz;
					    vs_TEXCOORD4.w = u_xlat8.x;
					    u_xlat8.xy = vec2(_UnderlaySoftness, _UnderlayDilate) * vec2(vec2(_ScaleRatioC, _ScaleRatioC));
					    u_xlat8.x = u_xlat8.x * u_xlat0.x + 1.0;
					    u_xlat0.x = u_xlat0.x / u_xlat8.x;
					    u_xlat8.x = u_xlat8.y * 0.5;
					    u_xlat4.x = u_xlat4.x * u_xlat0.x + -0.5;
					    vs_TEXCOORD5.y = (-u_xlat8.x) * u_xlat0.x + u_xlat4.x;
