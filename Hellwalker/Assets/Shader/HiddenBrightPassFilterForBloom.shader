			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    dcl_2d s0
					    texld_pp r0, v0, s0
					    add_pp r1.x, r0.w, c2.x
					    mov r1.y, c2.y
					    mad_pp r1.x, c1.x, r1.x, r1.y
					    mad_pp r0, r0, r1.x, -c0.x
					    max_pp oC0, r0, c2.z
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = useSrcAlphaAsMask * u_xlat16_1 + 1.0;
					    u_xlat0 = u_xlat10_0 * vec4(u_xlat1) + (-threshold.xxxx);
